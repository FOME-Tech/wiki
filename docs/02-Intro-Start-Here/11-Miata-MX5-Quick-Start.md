...
- Steps on where to download the firmware can be found [here](docs\02-Intro-Start-Here\03-Where-To-Get-Firmware.md).
- Steps on how to update the firmware can be found [here](docs\02-Intro-Start-Here\04-HT-Updating-The-Firmware.md)
