...
For ease of use and pinning, the following pinout layout and illustrations resembles the connectors being seen from the rear. (Wiring Harness Side)
Additionaly, the Pin Naming convention is broken down into the following:
...
| 1G3 | HS2         | High Side 2                                      |                                      |
| 1G4 | HS1         | High Side 1                                      |                                      |
| 1H1 | EXTRALSD    | (Extra Low Side D - from Ignition 12)            |                                      |
| 1H2 | EXTRALSC    | (Extra Low Side C - from Ignition 11)            |                                      |
| 1H3 | EXTRALSB    | (Extra Low Side B - from Ignition 10)            |                                      |
| 1H4 | EXTRALSA    | (Extra Low Side A - from Ignition 9 )            |                                      |
